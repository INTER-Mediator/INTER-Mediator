...
/* Dropbox Support
 * =================== */
//$dropboxAppKey= 'xxxxxxxxxxxx'; // App Key of your Dropbox app from App Console.
//$dropboxAppSecret= 'xxxxxxxxxxxx'; // App Secret of your Dropbox app from App Console.
//$dropboxRefreshToken= 'xxxxxxxxxxxxxxxxxxxx'; // Refresh token generated by something
...
//$rootInDropbox= '/'; // The prefix of the Dropbox path to store the file. The default is '/'.
