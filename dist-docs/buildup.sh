...
readFileUntilMark "${originalPath}/node_modules/jssha/src/sha.js" "${buildPath}/src/js/temp.js"
...
# readFileUntilMark "${originalPath}/node_modules/inter-mediator-locale/index.js" "${buildPath}/src/js/temp.js"
