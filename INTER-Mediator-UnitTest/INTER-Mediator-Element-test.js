...
buster.testCase('INTER-Mediator Element Test', {
    ...
    'IMLibElement.setValueToIMNode() should return false without TypeError (curVal.replace is not a function)': function () {
     ...
     'IMLibElement.checkOptimisticLock() should return false in case of handling of the local context without TypeError (contextInfo is null)': function () {'use strict';'use strict';
