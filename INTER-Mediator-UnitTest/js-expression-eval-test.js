...
//    },
    ...
    "date time functions.": function () {
        ...
        assert.equals(Parser.evaluate("datetimecomponents(2014,2,17,9,0,0)"), 1392595200);
        ...
        assert.equals(Parser.evaluate("addyeardt(datetime('2014-02-17 09:23:49'), 2)"),  1392596629+730*86400);
        assert.equals(Parser.evaluate("addmonthdt(datetime('2014-02-17 09:23:49'), 2)"), 1392596629+59*86400);
        assert.equals(Parser.evaluate("adddaydt(datetime('2014-02-17 09:23:49'), 2)"),   1392596629+2*86400);
        assert.equals(Parser.evaluate("addhourdt(datetime('2014-02-17 09:23:49'), 2)"),  1392596629+2*3600);
        assert.equals(Parser.evaluate("addminutedt(datetime('2014-02-17 09:23:49'), 2)"),1392596629+2*60);
        assert.equals(Parser.evaluate("addseconddt(datetime('2014-02-17 09:23:49'), 2)"),1392596629+2);
        assert.equals(Parser.evaluate("endofmonth(datetime('2014-02-17 09:23:49'))"), 11352);
        assert.equals(Parser.evaluate("startofmonth(datetime('2014-02-17 09:23:49'))"), 11322);
        assert.equals(Parser.evaluate("endofmonthd(datetime('2014-02-17 09:23:49'))"), 11352);
        assert.equals(Parser.evaluate("startofmonthd(datetime('2014-02-17 09:23:49'))"), 11322);
        assert.equals(Parser.evaluate("endofmonthdt(datetime('2014-02-17 09:23:49'))"), 1393632060);
