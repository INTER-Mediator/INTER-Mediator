...
var IMLibCalc = {
        ...
        updateCalculationFields: function () {
            ...
            var targetNode, targetExp, field, valueSeries, targetElement, targetIds, i, counter,
                hasReferes, contextInfo, idValue, record;
...
/*
 The following source code was the file 'js-expression-eval-parser.js' in 'js_lib' directory.
 The Parser class was largely modified and it's suitable to place on the INTER-Mediator sources.
 Masayuki Nii (2015/3/15)
 */
