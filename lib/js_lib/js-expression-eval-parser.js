    ...
    Expression.prototype = {
        simplify: function (values) {
            ...
            return new Expression(
                newexpression, object(this.ops1), object(this.ops2), object(this.functions), object(this.ops3), object(this.ops3Trail));
        },
        ...
        toString: function (toJS) {
            ...
            for (i = 0; i < L; i++) {
                ...
                if (type_ === TNUMBER) {
                    ...
                    f = item.index_;
                    if (toJS && f == "^") {
                        nstack.push("Math.pow(" + n1 + "," + n2 + "," + n3 + ")");
                    }
                    else {
                        nstack.push("(" + n1 + f + n2 + f + n3 + ")");
                    }
                }
                else if (type_ === TOP2) {
                    n2 = nstack.pop();
    ...
    Parser.prototype = {
        parse: function (expr) {
            ...
            return new Expression(
                ...
                object(this.ops3), object(this.ops3Trail));
        },
...
//\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\
        ...
        isOp3: function () {
            ...
            if (str.length > 0 && (str in this.ops3)) {
                this.tokenindex = str;
                this.tokenprio = 5;
                this.pos += str.length;
                return true;
        ...
        isOp3Trail: function () {
            ...
            if (str.length > 0 && (str in this.ops3Trail)) {
                this.tokenindex = str;
                this.tokenprio = 5;
                this.pos += str.length;
                return true;
