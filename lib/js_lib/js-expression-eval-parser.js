...
//		}
//	}
// This 'patch' is already added in the INTER-Mediator. So I commented it out. (msyk Mar 3, 2014)
...
var Parser = (function (scope) {
    ...
    Parser.regFirstVarChar = new RegExp("[\u00A0-\u1FFF\2C00-\uDFFFa-zA-Z@_]");
    Parser.regRestVarChar = new RegExp("[\u00A0-\u1FFF\2C00-\uDFFFa-zA-Z@_0-9]");
    ...
    function sub(a, b) {
        var pos = 0, str, vala, valb;
        vala = (a instanceof Array) ? a.join() : a;
        valb = (b instanceof Array) ? b.join() : b;

        if (!isNaN(parseFloat(b)) && !isNaN(parseFloat(a))) {
            return a - b;   // Numeric substruct
        }
        str = vala;
        do {  // String substruct
    ...
    function itemsetand(a, b) {
        var stra, strb, arraya, arrayb, i, result = '', nls, nl = "\n";
        stra = (a instanceof Array) ? a.join() : a;
                ...
                if (this.isOperator()) {
                    if (this.isSign() && (expected & SIGN)) {
                        ...
                        if (this.tokenindex == "?") {
                            ...
                            noperators += 3;
                            this.addfunc(tokenstack, operstack, TOP3);
                        } else {
                            noperators += 2;
                    ...
                    this.addfunc(tokenstack, operstack, SEP);
                    noperators += 2;
                    expected = (PRIMARY | LPAREN | FUNCTION | SIGN);
                }
                    ...
                    if (this.tokenindex in Parser.functions) {
                        var vartoken = new Token(TFUNCALL, Parser.functions[this.tokenindex], 0, 0);
