...
<tr>
	...
	<td>
		<input type="radio" name="contact@way" value="301" />Direct
		<input type="radio" name="contact@way" value="302" />Phone
		<input type="radio" name="contact@way" value="303" />Another
	</td>
	<td>
	...
	<td><textarea name="contact@description"></textarea></td>
</tr>
</table>
<table border="1">
...
<tr>
	...
	<td><input type="text" name="history@startdate" /></td>
	<td><input type="text" name="history@enddate" /></td>
	<td><input type="text" name="history@description" /></td>
</tr>
</table>
