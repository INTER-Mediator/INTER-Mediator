...
var $messages = array(
    ...
    1007 => "On calling db_update, Requred parameter 'table' doesn't specified",
    1008 => "On calling db_update, Requred parameter 'key' doesn't specified",
    ...
    1019 => "On calling db_delete, Requred parameter 'table' doesn't specified",
    1020 => "On calling db_delete, Requred parameter 'dataset' doesn't specified",
