...
var $messages = array(
    ...
    1006 => "db_query関数の呼び出しで、必須のプロパティ'table'が指定されていません",
    1007 => "db_update関数の呼び出しで、必須のプロパティ'table'が指定されていません",
    1008 => "db_update関数の呼び出しで、必須のプロパティ'key'が指定されていません",
    1009 => "db_update関数の呼び出しで、必須のプロパティ'operatorが指定されていません",
    1010 => "db_update関数の呼び出しで、必須のプロパティ'value'が指定されていません",
    ...
    1017 => "削除アクセス: ",
    1018 => "新規レコードアクセス: ",
    1019 => "db_delete関数の呼び出しで、必須のプロパティ'table'が指定されていません",
    1020 => "db_delete関数の呼び出しで、必須のプロパティ'dataset'が指定されていません",
    1021 => "db_createRecord関数の呼び出しで、必須のプロパティ'table'が指定されていません",
