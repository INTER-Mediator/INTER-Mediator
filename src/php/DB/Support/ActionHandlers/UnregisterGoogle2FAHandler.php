...
class UnregisterGoogle2FAHandler extends ActionHandler
{
    use PasskeySupport;
    ...
    public function dataOperation(): void
    {
        try {
            ...
            $this->proxy->dbClass->authHandler->authSupportStore2FASecret($uid, null);
        } catch (Exception $e) {
            Logger::getInstance()->setDebugMessage(
                "[UnregisterGoogle2FAHandler] Exception:" . $e->getMessage(), 2);
        }
    }
