...
class OperationLog
{
    ...
    public function __construct(?array $options)
    {
        ...
        $this->recordingContexts = Params::getParameterValue("recordingContexts", []);
        ...
        $this->recordingOperations = Params::getParameterValue("recordingOperations", []);
    ...
    public function setEntry(?array $result): void
    {
        ...
        if (
            (count($this->recordingOperations) > 0 && !in_array($access, $this->recordingOperations))
        ...
        if (count($this->recordingContexts) > 0 && !in_array($targetContext, $this->recordingContexts)) {
            return;
        }
