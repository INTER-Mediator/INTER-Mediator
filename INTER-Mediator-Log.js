...
/* global IMLibContextPool, INTERMediator, INTERMediatorOnPage, IMLibMouseEventDispatch, IMLibLocalContext,
 ...
 IMLibEventResponder, IMLibElement, Parser, IMLib, console: false */
...
var INTERMediatorLog = {
    ...
    setErrorMessage: function (ex, moreMessage) {
        ...
        if (INTERMediatorLog.errorMessageByAlert) {
            window.alert(INTERMediatorLog.errorMessageOnAlert === null ?
                (ex + moreMessage) : INTERMediatorLog.errorMessageOnAlert);
        }
