...
describe('Form Page', () => {
  ...
  it('detail area expanded with multi-record', async () => {
    ...
    await expect(FormPage.rowContactDateTime[0]).toHaveValue('2009-12-01T06:23')
    ...
    await expect(FormPage.rowContactDateTime[1]).toHaveValue('2009-12-02T06:23')
    ...
    await expect(FormPage.rowContactDateTime[2]).toHaveValue('2009-12-03T06:23')
