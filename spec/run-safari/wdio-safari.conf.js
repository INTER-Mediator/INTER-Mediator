exports.config = {
  ...
  specs: [
    ...
    // '../run/test/specs/auth_page_credential_basic_mysql.e2e.js',
    // '../run/test/specs/auth_page_credential_basic_postgresql.e2e.js',
    // '../run/test/specs/auth_page_credential_basic_sqlite.e2e.js',
